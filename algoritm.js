...
const operations = [
    ...
    {
        datetime: '2020-11-14 12:35',
        sum: -250,
        category: 'Продукты'
    },
    {
        datetime: '2020-11-15 17:38',
        sum: -1204,
        category: 'Продукты'
    },
    
    {
        datetime: '2020-11-14 10:14',
        sum: -25,
        category: 'Проезд'
    },
    {
        datetime: '2020-11-12 09:54',
        sum: -50,
        category: 'Проезд'
    },
    {
        datetime: '2020-11-18 09:48',
        sum: -25,
        category: 'Проезд'
    },
    
    {
        datetime: '2020-11-18 08:15',
        sum: -1500,
        category: 'Заправка'
    },
    {
        datetime: '2020-11-11 08:15',
        sum: -2000,
        category: 'Заправка'
    },
    {
        datetime: '2020-11-19 07:45',
        sum: -1000,
        category: 'Заправка'
    },
];
...
const newOperations = [
    {
        datetime: '2020-12-01 12:43',  // Столовая (всегда во время обеда)
        sum: -195,
    },
    {
        datetime: '2020-12-01 19:24',  // Продукты (покупает по вечерам или по выходным)
        sum: -1354,
    },
    {
        datetime: '2020-12-05 10:24',  // Продукты (покупает по вечерам или по выходным)
        sum: -450,
    },
    {
        datetime: '2020-12-05 09:10',  // Проезд (обычно сумма всегда маленькая)
        sum: -50,
    },
    {
        datetime: '2020-12-04 07:50',  // Заправка (обычно с утра)
        sum: -1000,
    },
];
